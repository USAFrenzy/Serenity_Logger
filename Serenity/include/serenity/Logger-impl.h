...
{
	if( ( se_utils::ToMappedLevel( GetLogLevel( ) ) <= MappedLevel::debug ) && ( ShouldLog( ) ) ) {
...
{
	if( ( se_utils::ToMappedLevel( GetLogLevel( ) ) <= MappedLevel::info ) && ( ShouldLog( ) ) ) {
...
{
	if( ( se_utils::ToMappedLevel( GetLogLevel( ) ) <= MappedLevel::warn ) && ( ShouldLog( ) ) ) {
...
{
	if( ( se_utils::ToMappedLevel( GetLogLevel( ) ) <= MappedLevel::err ) && ( ShouldLog( ) ) ) {
...
{
	if( ( se_utils::ToMappedLevel( GetLogLevel( ) ) <= MappedLevel::critical ) && ( ShouldLog( ) ) ) {

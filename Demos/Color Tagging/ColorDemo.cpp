...
// TODO: FIX FORMATTING AND TRY TO FIND A WORK-AROUND FOR THE ANNOYING BACKGROUND COLOR WRAP WITH EMPTY CELLS
int main( )
{
	using namespace se_colors;

	std::cout << Tag::Blue( "\n\nSome " ) << Tag::Cyan( "Examples " ) << Tag::Green( "Of " ) << Tag::Magenta( "Specific " )
		  << Tag::Bright_Red_On_Bright_White( "Word" ) << " " << Tag::Red( "Color " ) << Tag::Yellow( "Tagging" )
		  << Tag::Bright_Green( "!\n\n" );
	...
	std::cout << Tag::Red_On_Black( "Red On Black" ) << Tag::Red_On_Red( "Red On Red" ) << Tag::Red_On_Green( "Red On Green" )
		  << Tag::Red_On_Yellow( "Red On Yellow" ) << Tag::Red_On_Blue( "Red On Blue" )
		  << Tag::Red_On_Magenta( "Red On Magenta" ) << Tag::Red_On_Cyan( "Red On Cyan" )
		  << Tag::Red_On_White( "Red On White\n" );
	...
	std::cout << Tag::Blue( "Blue" ) << Tag::Blue_On_Black( "Blue On Black" ) << Tag::Blue_On_Red( "Blue On Red" )
		  << Tag::Blue_On_Green( "Blue On Green" ) << Tag::Blue_On_Yellow( "Blue On Yellow" )
		  << Tag::Blue_On_Blue( "Blue On Blue" ) << Tag::Blue_On_Magenta( "Blue On Magenta" )
		  << Tag::Blue_On_Cyan( "Blue On Cyan" ) << Tag::Blue_On_White( "Blue On White\n" );
	...
	std::cout << Tag::Black_On_Grey( "Black On Grey" ) << Tag::Black_On_Bright_Red( "Black On Bright Red" )
		  << Tag::Black_On_Bright_Green( "Black On Bright Green" ) << Tag::Black_On_Bright_Yellow( "Black On Bright Yellow" )
		  << Tag::Black_On_Bright_Blue( "Black On Bright Blue" ) << Tag::Black_On_Bright_Magenta( "Black On Bright Magenta" )
		  << Tag::Black_On_Bright_Cyan( "Black On Bright Cyan" ) << Tag::Black_On_Bright_White( "Black On Bright White\n" );

	std::cout << Tag::Red_On_Grey( "Red On Grey" ) << Tag::Red_On_Bright_Red( "Red On Bright Red" )
		  << Tag::Red_On_Bright_Green( "Red On Bright Green" ) << Tag::Red_On_Bright_Yellow( "Red On Bright Yellow" )
		  << Tag::Red_On_Bright_Blue( "Red On Bright Blue" ) << Tag::Red_On_Bright_Magenta( "Red On Bright Magenta" )
		  << Tag::Red_On_Bright_Cyan( "Red On Bright Cyan" ) << Tag::Red_On_Bright_White( "Red On Bright White\n" );

	std::cout << Tag::Green_On_Grey( "Green On Grey" ) << Tag::Green_On_Bright_Red( "Green On Bright Red" )
		  << Tag::Green_On_Bright_Green( "Green On Bright Green" ) << Tag::Green_On_Bright_Yellow( "Green On Bright Yellow" )
		  << Tag::Green_On_Bright_Blue( "Green On Bright Blue" ) << Tag::Green_On_Bright_Magenta( "Green On Bright Magenta" )
		  << Tag::Green_On_Bright_Cyan( "Green On Bright Cyan" ) << Tag::Green_On_Bright_White( "Green On Bright White\n" );

	std::cout << Tag::Yellow_On_Grey( "Yellow On Grey" ) << Tag::Yellow_On_Bright_Red( "Yellow On Bright Red" )
		  ...
		  << Tag::Yellow_On_Bright_Cyan( "Yellow On Bright Cyan" ) << Tag::Yellow_On_Bright_White( "Yellow On Bright White\n" );

	std::cout << Tag::Blue_On_Grey( "Blue On Grey" ) << Tag::Blue_On_Bright_Red( "Blue On Bright Red" )
		  << Tag::Blue_On_Bright_Green( "Blue On Bright Green" ) << Tag::Blue_On_Bright_Yellow( "Blue On Bright Yellow" )
		  << Tag::Blue_On_Bright_Blue( "Blue On Bright Blue" ) << Tag::Blue_On_Bright_Magenta( "Blue On Bright Magenta" )
		  << Tag::Blue_On_Bright_Cyan( "Blue On Bright Cyan" ) << Tag::Blue_On_Bright_White( "Blue On Bright White\n" );

	std::cout
	  << Tag::Magenta_On_Grey( "Magenta On Grey" ) << Tag::Magenta_On_Bright_Red( "Magenta On Bright Red" )
	  ...
	  << Tag::Magenta_On_Bright_Cyan( "Magenta On Bright Cyan" ) << Tag::Magenta_On_Bright_White( "Magenta On Bright White\n" );

	std::cout << Tag::Cyan_On_Grey( "Cyan On Grey" ) << Tag::Cyan_On_Bright_Red( "Cyan On Bright Red" )
		  << Tag::Cyan_On_Bright_Green( "Cyan On Bright Green" ) << Tag::Cyan_On_Bright_Yellow( "Cyan On Bright Yellow" )
		  << Tag::Cyan_On_Bright_Blue( "Cyan On Bright Blue" ) << Tag::Cyan_On_Bright_Magenta( "Cyan On Bright Magenta" )
		  << Tag::Cyan_On_Bright_Cyan( "Cyan On Bright Cyan" ) << Tag::Cyan_On_Bright_White( "Cyan On Bright White\n" );

	std::cout << Tag::White_On_Grey( "White On Grey" ) << Tag::White_On_Bright_Red( "White On Bright Red" )
		  << Tag::White_On_Bright_Green( "White On Bright Green" ) << Tag::White_On_Bright_Yellow( "White On Bright Yellow" )
		  << Tag::White_On_Bright_Blue( "White On Bright Blue" ) << Tag::White_On_Bright_Magenta( "White On Bright Magenta" )
		  << Tag::White_On_Bright_Cyan( "White On Bright Cyan" ) << Tag::White_On_Bright_White( "White On Bright White\n" );
	...
	std::cout << Tag::Bright_Red_On_Black( "Bright Red On Black" ) << Tag::Bright_Red_On_Red( "Bright Red On Red" )
		  << Tag::Bright_Red_On_Green( "Bright Red On Green" ) << Tag::Bright_Red_On_Yellow( "Bright Red On Yellow" )
		  << Tag::Bright_Red_On_Blue( "Bright Red On Blue" ) << Tag::Bright_Red_On_Magenta( "Bright Red On Magenta" )
		  << Tag::Bright_Red_On_Cyan( "Bright Red On Cyan" ) << Tag::Bright_Red_On_White( "Bright Red On White\n" );

	std::cout << Tag::Bright_Green_On_Black( "Bright Green On Black" ) << Tag::Bright_Green_On_Red( "Bright Green On Red" )
		  ...
		  << Tag::Bright_Green_On_Cyan( "Bright Green On Cyan" ) << Tag::Bright_Green_On_White( "Bright Green On White\n" );

	std::cout << Tag::Bright_Yellow_On_Black( "Bright Yellow On Black" ) << Tag::Bright_Yellow_On_Red( "Bright Yellow On Red" )
		  << Tag::Bright_Yellow_On_Green( "Bright Yellow On Green" )
		  << Tag::Bright_Yellow_On_Yellow( "Bright Yellow On Yellow" ) << Tag::Bright_Yellow_On_Blue( "Bright Yellow On Blue" )
		  << Tag::Bright_Yellow_On_Magenta( "Bright Yellow On Magenta" )
		  << Tag::Bright_Yellow_On_Cyan( "Bright Yellow On Cyan" ) << Tag::Bright_Yellow_On_White( "Bright Yellow On White\n" );

	std::cout << Tag::Bright_Blue( "Bright Blue" ) << Tag::Bright_Blue_On_Black( "Bright Blue On Black" )
		  << Tag::Bright_Blue_On_Red( "Bright Blue On Red" ) << Tag::Bright_Blue_On_Green( "Bright Blue On Green" )
		  << Tag::Bright_Blue_On_Yellow( "Bright Blue On Yellow" ) << Tag::Bright_Blue_On_Blue( "Bright Blue On Blue" )
		  << Tag::Bright_Blue_On_Magenta( "Bright Blue On Magenta" ) << Tag::Bright_Blue_On_Cyan( "Bright Blue On Cyan" )
		  << Tag::Bright_Blue_On_White( "Bright Blue On White\n" );

	std::cout
	  << Tag::Bright_Magenta_On_Black( "Bright Magenta On Black" ) << Tag::Bright_Magenta_On_Red( "Bright Magenta On Red" )
	  ...
	  << Tag::Bright_Magenta_On_Cyan( "Bright Magenta On Cyan" ) << Tag::Bright_Magenta_On_White( "Bright Magenta On White\n" );

	std::cout << Tag::Bright_Cyan_On_Black( "Bright Cyan On Black" ) << Tag::Bright_Cyan_On_Red( "Bright Cyan On Red" )
		  ...
		  << Tag::Bright_Cyan_On_Cyan( "Bright Cyan On Cyan" ) << Tag::Bright_Cyan_On_White( "Bright Cyan On White\n" );

	std::cout << Tag::Bright_White_On_Black( "Bright_White On Black" ) << Tag::Bright_White_On_Red( "Bright White On Red" )
		  ...
		  << Tag::Bright_White_On_Cyan( "Bright White On Cyan" ) << Tag::Bright_White_On_White( "Bright White On White\n" );
	...
	std::cout << Tag::Bright_Red_On_Grey( "Bright Red On Grey" ) << Tag::Bright_Red_On_Bright_Red( "Bright Red On Bright Red" )
	...
	std::cout << Tag::Bright_Blue_On_Grey( "Bright Blue On Grey" ) << Tag::Bright_Blue_On_Bright_Red( "Bright Blue On Bright Red" )
	...
	std::cout << Tag::Bright_Cyan_On_Grey( "Bright Cyan On Grey" ) << Tag::Bright_Cyan_On_Bright_Red( "Bright Cyan On Bright Red" )
